# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-03-20 07:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('componet', models.CharField(blank=True, max_length=256, null=True, verbose_name='事件子项')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_asset_type', models.IntegerField(choices=[(0, '路由器'), (1, '交换机'), (2, '负载均衡'), (4, 'VPN设备')], default=0, verbose_name='网络设备类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(blank=True, max_length=1128, null=True, verbose_name='内存型号')),
                ('manufacture', models.CharField(blank=True, max_length=128, null=True, verbose_name='内存制造商')),
        ...
        migrations.AddField(
            model_name='eventlog',
            name='new_asset',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET, to='assets.NewAssetApprovalZone'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='时间执行人'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
